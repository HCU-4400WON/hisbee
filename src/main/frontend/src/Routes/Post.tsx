      ...
      <PostGrid className="">
        {posts.map((post, index) => (
          ...
          >
            ...
            >
              <span className="text-[#185ee4] bg-[#fff] h-[25px] border w-[80px] text-[15px] font-bold rounded-full flex items-center justify-center">
                <label>
                  {post.dtype === "P"
                    ? "프로젝트"
                    : post.dtype === "S"
       ...
       <p className="text-sm text-blue-500">{post.total}명 모집</p> */}
            ...
            <div
              id="restPart"
              className="bg-[#e9e9eb] w-full h-full px-[25px] py-[15px]"
            >
              {/* secondRow */}
              ...
              <div className="flex text-[12px] font-semibold items-center">
                ...
                <p>
                  {" "}
                  {post.projectStart.getMonth()}월 {post.projectStart.getDate()}
                  일 시작
                </p>
              </div>

              {/* lastRow */}
              <div className="absolute left-[25px] bottom-[15px] flex items-center gap-2">
                <p className=" text-[#185ee4] font-bold text-[14px]">
                  {post.dtype === "P"
                ...
                {post.dtype === "P" ? (
                  <>
                    {post.maxDeveloper !== 0 && (
                      <span className="border-gray-400 border rounded-full px-[10px] text-[11px] text-gray-500 font-medium">
