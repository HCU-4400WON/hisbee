...
public class PostFilterTests {
    ...
    void memberSetup() {
        ...
        member1.update(
                MemberRequest.builder().nickname("member1").major1(Major.VCD).major2(Major.CS).build());
    ...
    public void 모집유형에_해당하는_모집글을_필터링한다() throws Exception {
        ...
        // when
        final var filter = PostSearchFilter.builder().type("학회").email(TEST_EMAIL).build();
    ...
    public void 모집유형에_해당하지_않는_모집글은_나오지_않는다() throws Exception {
        ...
        // when
        final var filter = PostSearchFilter.builder().type("동아리").email(TEST_EMAIL).build();
    ...
    public void 썸네일_태그를_키워드로_필터링한다() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().keywords("축복").email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 모집유형과_키워드를_모두_만족하는_모집글을_필터링한다() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().type("학회").keywords("온유").email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 타겟_학년을_포함한_필터링이_되어야한다() {
        ...
        // when
        var filter =
                PostSearchFilter.builder().year(Year.SOPHOMORE).page(1).limit(3).email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 내_전공을_포함한_필터링이_되어야한다() {
        ...
        // when
        var filter = PostSearchFilter.builder().myDeptOnly(true).email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 썸네일_제목도_포함하여_필터링한다() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().keywords("최강").email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 썸네일_한줄소개_포함하여_필터링한다() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().keywords("직관").email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 페이지_limit만큼만_읽어온다() throws Exception {
        ...
        for (int i = 0; i < 13; i++) postService.createPost(request, TEST_EMAIL);

        // when
        var filter = PostSearchFilter.builder().page(2).limit(8).email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 기타_모집글_필터링() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().page(1).limit(3).type("기타").email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
    ...
    public void 모든_모집글_불러오기() throws Exception {
        ...
        // when
        MvcResult mvcResult =
                mvc.perform(get("/posts")).andDo(print()).andExpect(status().isOk()).andReturn();

        var response =
                objectMapper.readValue(
                        mvcResult.getResponse().getContentAsString(), PostFilterResponse.class);
    ...
    public void 좋아요_hasLike_true_test() throws Exception {
        ...
        // when
        var filter = PostSearchFilter.builder().page(1).limit(3).email(TEST_EMAIL).build();
        var response =
                postService.readFilteredPost(filter).stream()
    ...
    public void 마감된모집글제외() throws Exception {
        ...
        // when
        var filter =
                PostSearchFilter.builder().page(1).limit(3).openOnly(true).email(TEST_EMAIL).build();
        var response = postService.readFilteredPost(filter);
