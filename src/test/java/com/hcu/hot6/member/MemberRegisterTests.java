...
public class MemberRegisterTests {
    ...
    public void 닉네임이_존재하지_않는_경우() throws Exception {
        ...
        MvcResult mvcResult =
                mvc.perform(get("/users/validation").param("nickname", target))
        ...
        // then
        assertThrows(NoResultException.class, () -> repository.findByNickname(target));
    ...
    public void 닉네임이_이미_존재하는_경우() throws Exception {
        ...
        // then
        assertDoesNotThrow(() -> repository.findByNickname("monsters"));
